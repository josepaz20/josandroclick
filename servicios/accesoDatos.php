        ...
        foreach ($consultas as $consult) {
            ...
            if ($this->conn->query($consult)) {
                if (strpos($consult, 'INSERT') !== false) {
                    if (strpos($consult, 'INSERT INTO internet') === false && strpos($consult, 'INSERT INTO lantolan') === false && strpos($consult, 'INSERT INTO observacion') === false && strpos($consult, 'INSERT INTO contrato_factura') === false && strpos($consult, 'INSERT INTO concepto_factura') === false && strpos($consult, 'INSERT INTO viatico_actividad') === false && strpos($consult, 'INSERT INTO usuario') === false && strpos($consult, 'INSERT INTO clausula_tipo') === false && strpos($consult, 'INSERT INTO clausulas_contrato') === false && strpos($consult, 'INSERT INTO encuesta_cuidadocliente') === false && strpos($consult, 'INSERT INTO cobro') === false && strpos($consult, 'INSERT INTO item_compra') === false) {
                        $this->ultimo_id = $this->conn->insert_id;
                    }
                    if (strpos($consult, 'INSERT INTO recaudo') !== false) {
